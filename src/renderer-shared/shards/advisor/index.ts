...
import { PantheonAdvice, PantheonAdvicePriority } from '@shared/utils/engine'
...
export const useCoachAdvisorStore = defineStore('coach-advisor', () => {
  const settings = ref({
    ...
    minPriority: PantheonAdvicePriority.INFO as PantheonAdvicePriority,
...
export class CoachAdvisorRenderer implements IAkariShardInitDispose {
  ...
  setMinPriority(value: PantheonAdvicePriority) {
