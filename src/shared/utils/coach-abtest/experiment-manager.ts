import type { CoachAdvice, CoachAdviceType } from '../coach-engine'
import type { GamePhase } from '../coach-scheduler'
import type { FeatureVector, TrainingSample } from '../coach-capture/experiment-capture'
...
export class CoachExperimentManager {
...
export function createExperimentManager(): CoachExperimentManager {
  return new CoachExperimentManager()
}
