...
import type { AggregatedTeamProfile, TeamComparisonResult } from '../cache/aggregator'
import type { GamePhase, ScheduledAdvice } from '../scheduler'
import type { PantheonChanges, DataAvailability } from '../cache/query'
import { createPantheonChanges } from '../cache/query'
...
export class ExperimentCapture {
  ...
  captureAdviceDelivered(advice: PantheonAdvice, gamePhase: GamePhase): CaptureEvent {
    const event: CaptureEvent = {
      id: generateCaptureId(),
