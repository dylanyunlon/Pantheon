 ...
 */
export async function convertWireToPantheonRecords(
...
export async function convertWireToPantheonRecords(
  ...
  for (const rawObj of objects) {
    ...
    let coachRecord: ObjectHolder | InterfaceHolder = createPantheonRecord(
      client,
      objectDef as any,
      rawObj,
...
function fixObjectPropertiesInPlace(
  ...
  forceRemoveRid: boolean,
): asserts objs is SimplePantheonProperties[] {
