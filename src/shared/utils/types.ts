...
export interface PantheonRecordBase {
  $objectType: string
  $primaryKey: string
  $apiName: string
}
...
export const dylanyunlonApiError = PantheonApiError
...
export type PantheonBase<Q extends ObjectOrInterfaceDefinition = ObjectOrInterfaceDefinition> = ObjectIdentifiers<Q> & {
...
export type MinimalPantheonClient = import('./client/MinimalPantheonClientContext').MinimalPantheonClient
...
export type PantheonRecordLinksObject<_Q = any> = Record<string, unknown>
...
export type SimplePantheonProperties = { $objectType: string; $primaryKey: string | number; [key: symbol]: unknown; $apiName?: string; $piiFieldType?: unknown; $piiKey?: unknown; $title?: string; $rid?: string; [key: string]: unknown }
...
export type PantheonClient = MinimalPantheonClient
...
export function createPantheonRecord(_client: unknown, _def: unknown, _props: unknown): ScrubRecord { return { $objectType: '', $primaryKey: '' } as ScrubRecord }
